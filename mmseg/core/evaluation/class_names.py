...
def zblWaterDataset_2class_classes():
    """stare class names for external use."""
    return ["background", "water_black","water_droplets"]
def zblWaterDataset_2class_palette():
    """STARE palette for external use."""
...
dataset_aliases = {
    ...
    'isaid': ['isaid', 'iSAID'],
    'stare': ['stare', 'STARE'],
    'zblWaterDataset_2class': ['zblWaterDataset_2class'],
}
