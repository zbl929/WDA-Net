...
class Attention_odconv(nn.Module):
    def __init__(self, in_planes, out_planes, kernel_size, groups=1, reduction=0.0625, kernel_num=4, min_channel=16):
        super(Attention_odconv, self).__init__()
...
class ODConv2d(nn.Module):
    def __init__(self, in_planes, out_planes, kernel_size, stride=1, padding=0, dilation=1, groups=1,
        ...
        self.groups = groups
        self.kernel_num = kernel_num
        self.attention = Attention_odconv(in_planes, out_planes, kernel_size, groups=groups,
...
def odconv3x3(in_planes, out_planes, stride=1, reduction=0.0625, kernel_num=1,groups=1):
    return ODConv2d(in_planes, out_planes, kernel_size=3, stride=stride, padding=1,groups=1,
                    reduction=reduction, kernel_num=kernel_num)
...
class PatchEmbed(nn.Module):
    def __init__(self,
        ...
        if stride == 2:
            ...
            # self.conv = odconv1x1(in_planes=in_channels, out_planes=out_channels)
...
class MHCA(nn.Module):
    ...
    def __init__(self, out_channels, head_dim):
        ...
        self.group_conv3x3 = odconv3x3(out_channels, out_channels)
        self.norm = norm_layer(out_channels)
        self.act = nn.ReLU(inplace=True)
        self.projection = nn.Conv2d(out_channels, out_channels, kernel_size=1, bias=False)
        # self.projection = odconv1x1(in_planes=out_channels, out_planes=out_channels)
...
class Mlp(nn.Module):
    def __init__(self, in_features, out_features=None, mlp_ratio=None, drop=0., bias=True):
        ...
        # self.conv1 = odconv1x1(in_features, hidden_dim)
        self.act = nn.ReLU(inplace=True)
        self.conv2 = nn.Conv2d(hidden_dim, out_features, kernel_size=1, bias=bias)
        # self.conv2 = odconv1x1(hidden_dim, out_features)
...
class nextvit_odconv(NextViT):
    def __init__(self, resume='', **kwargs):
        super(nextvit_odconv, self).__init__(
