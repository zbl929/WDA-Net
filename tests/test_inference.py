...
def test_test_time_augmentation_on_cpu():
    config_file = 'configs/next_vit/nextvit.py'
    ...
    checkpoint_file = r'D:\CV_project\mmsegmentation-0.23.0\tools\logs\zbl_next-vit\latest.pth'
    model = init_segmentor(config, checkpoint_file, device='cpu')

    img = mmcv.imread(
        osp.join(osp.dirname(__file__), r"C:\Users\张布霖\Desktop\new_data\微信图片_20230512163838.jpg"), 'color')
